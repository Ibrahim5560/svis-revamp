...
import com.isoft.svisrevamp.service.QuestionsQueryService;
...
/**
 * REST controller for managing {@link com.isoft.svisrevamp.domain.Questions}.
 */
@RestController
@RequestMapping("/api")
public class QuestionsResource {
    ...
    public ResponseEntity<QuestionsDTO> updateQuestions(
        ...
        QuestionsDTO result = questionsService.update(questionsDTO);
        return ResponseEntity
            .ok()
