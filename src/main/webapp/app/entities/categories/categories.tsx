  ...
  return (
    <div>
      <h2 id="categories-heading" data-cy="CategoriesHeading">
        <Translate contentKey="svisRevampApp.categories.home.title">Categories</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="svisRevampApp.categories.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/categories/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="svisRevampApp.categories.home.createLabel">Create new Categories</Translate>
          </Link>
        </div>
      </h2>
        ...
        {categoriesList && categoriesList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="svisRevampApp.categories.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('nameAr')}>
                  <Translate contentKey="svisRevampApp.categories.nameAr">Name Ar</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('nameEn')}>
                  <Translate contentKey="svisRevampApp.categories.nameEn">Name En</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="svisRevampApp.categories.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="svisRevampApp.categories.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {categoriesList.map((categories, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{categories.nameAr}</td>
                  <td>{categories.nameEn}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="svisRevampApp.categories.home.notFound">No Categories found</Translate>
            </div>
          )
        )}
      </div>
