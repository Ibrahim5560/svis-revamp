...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXAMQUESTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXAMQUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXAMQUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXAMQUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXAMQUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXAMQUESTIONS actions', async () => {
      const expectedActions = [
        {
