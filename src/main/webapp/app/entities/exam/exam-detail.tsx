    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{examEntity.validfrom ? <TextFormat value={examEntity.validfrom} type="date" format={APP_LOCAL_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="validto">
              <Translate contentKey="svisRevampApp.exam.validto">Validto</Translate>
            </span>
          </dt>
          <dd>{examEntity.validto ? <TextFormat value={examEntity.validto} type="date" format={APP_LOCAL_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="startAt">
          ...
          <dd>{examEntity.examDate ? <TextFormat value={examEntity.examDate} type="date" format={APP_LOCAL_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="examResult">
