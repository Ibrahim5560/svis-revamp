            ...
            <tbody>
              {examList.map((exam, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{exam.validfrom ? <TextFormat type="date" value={exam.validfrom} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
                  <td>{exam.validto ? <TextFormat type="date" value={exam.validto} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
                  ...
                  <td>{exam.examCode}</td>
                  <td>{exam.examDate ? <TextFormat type="date" value={exam.examDate} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
