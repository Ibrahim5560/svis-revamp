...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './template-categories.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATECATEGORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPLATECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPLATECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPLATECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPLATECATEGORIES actions', async () => {
      const expectedActions = [
        {
