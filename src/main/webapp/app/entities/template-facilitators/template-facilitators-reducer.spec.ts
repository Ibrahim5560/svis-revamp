...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './template-facilitators.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATEFACILITATORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPLATEFACILITATORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPLATEFACILITATORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPLATEFACILITATORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATEFACILITATORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPLATEFACILITATORS actions', async () => {
      const expectedActions = [
        {
