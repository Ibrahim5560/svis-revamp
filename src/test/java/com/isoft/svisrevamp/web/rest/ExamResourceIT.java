...
class ExamResourceIT {
    ...
    private static final LocalDate SMALLER_VALIDFROM = LocalDate.ofEpochDay(-1L);

    private static final LocalDate DEFAULT_VALIDTO = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_VALIDTO = LocalDate.now(ZoneId.systemDefault());
    private static final LocalDate SMALLER_VALIDTO = LocalDate.ofEpochDay(-1L);
    ...
    @Test
    @Transactional
    void getAllExamsByValidfromIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where validfrom is greater than or equal to DEFAULT_VALIDFROM
        defaultExamShouldBeFound("validfrom.greaterThanOrEqual=" + DEFAULT_VALIDFROM);

        // Get all the examList where validfrom is greater than or equal to UPDATED_VALIDFROM
        defaultExamShouldNotBeFound("validfrom.greaterThanOrEqual=" + UPDATED_VALIDFROM);
    }

    @Test
    @Transactional
    void getAllExamsByValidfromIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where validfrom is less than or equal to DEFAULT_VALIDFROM
        defaultExamShouldBeFound("validfrom.lessThanOrEqual=" + DEFAULT_VALIDFROM);

        // Get all the examList where validfrom is less than or equal to SMALLER_VALIDFROM
        defaultExamShouldNotBeFound("validfrom.lessThanOrEqual=" + SMALLER_VALIDFROM);
    }

    @Test
    @Transactional
    void getAllExamsByValidfromIsLessThanSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where validfrom is less than DEFAULT_VALIDFROM
        defaultExamShouldNotBeFound("validfrom.lessThan=" + DEFAULT_VALIDFROM);

        // Get all the examList where validfrom is less than UPDATED_VALIDFROM
        defaultExamShouldBeFound("validfrom.lessThan=" + UPDATED_VALIDFROM);
    }

    @Test
    @Transactional
    void getAllExamsByValidfromIsGreaterThanSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where validfrom is greater than DEFAULT_VALIDFROM
        defaultExamShouldNotBeFound("validfrom.greaterThan=" + DEFAULT_VALIDFROM);

        // Get all the examList where validfrom is greater than SMALLER_VALIDFROM
        defaultExamShouldBeFound("validfrom.greaterThan=" + SMALLER_VALIDFROM);
    }
    ...
    @Test
    @Transactional
    void getAllExamsByValidtoIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where validto is greater than or equal to DEFAULT_VALIDTO
        defaultExamShouldBeFound("validto.greaterThanOrEqual=" + DEFAULT_VALIDTO);

        // Get all the examList where validto is greater than or equal to UPDATED_VALIDTO
        defaultExamShouldNotBeFound("validto.greaterThanOrEqual=" + UPDATED_VALIDTO);
    }

    @Test
    @Transactional
    void getAllExamsByValidtoIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where validto is less than or equal to DEFAULT_VALIDTO
        defaultExamShouldBeFound("validto.lessThanOrEqual=" + DEFAULT_VALIDTO);

        // Get all the examList where validto is less than or equal to SMALLER_VALIDTO
        defaultExamShouldNotBeFound("validto.lessThanOrEqual=" + SMALLER_VALIDTO);
    }

    @Test
    @Transactional
    void getAllExamsByValidtoIsLessThanSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where validto is less than DEFAULT_VALIDTO
        defaultExamShouldNotBeFound("validto.lessThan=" + DEFAULT_VALIDTO);

        // Get all the examList where validto is less than UPDATED_VALIDTO
        defaultExamShouldBeFound("validto.lessThan=" + UPDATED_VALIDTO);
    }

    @Test
    @Transactional
    void getAllExamsByValidtoIsGreaterThanSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where validto is greater than DEFAULT_VALIDTO
        defaultExamShouldNotBeFound("validto.greaterThan=" + DEFAULT_VALIDTO);

        // Get all the examList where validto is greater than SMALLER_VALIDTO
        defaultExamShouldBeFound("validto.greaterThan=" + SMALLER_VALIDTO);
    }
    ...
    @Test
    @Transactional
    void getAllExamsByExamDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where examDate is greater than or equal to DEFAULT_EXAM_DATE
        defaultExamShouldBeFound("examDate.greaterThanOrEqual=" + DEFAULT_EXAM_DATE);

        // Get all the examList where examDate is greater than or equal to UPDATED_EXAM_DATE
        defaultExamShouldNotBeFound("examDate.greaterThanOrEqual=" + UPDATED_EXAM_DATE);
    }

    @Test
    @Transactional
    void getAllExamsByExamDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where examDate is less than or equal to DEFAULT_EXAM_DATE
        defaultExamShouldBeFound("examDate.lessThanOrEqual=" + DEFAULT_EXAM_DATE);

        // Get all the examList where examDate is less than or equal to SMALLER_EXAM_DATE
        defaultExamShouldNotBeFound("examDate.lessThanOrEqual=" + SMALLER_EXAM_DATE);
    }

    @Test
    @Transactional
    void getAllExamsByExamDateIsLessThanSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where examDate is less than DEFAULT_EXAM_DATE
        defaultExamShouldNotBeFound("examDate.lessThan=" + DEFAULT_EXAM_DATE);

        // Get all the examList where examDate is less than UPDATED_EXAM_DATE
        defaultExamShouldBeFound("examDate.lessThan=" + UPDATED_EXAM_DATE);
    }

    @Test
    @Transactional
    void getAllExamsByExamDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        examRepository.saveAndFlush(exam);

        // Get all the examList where examDate is greater than DEFAULT_EXAM_DATE
        defaultExamShouldNotBeFound("examDate.greaterThan=" + DEFAULT_EXAM_DATE);

        // Get all the examList where examDate is greater than SMALLER_EXAM_DATE
        defaultExamShouldBeFound("examDate.greaterThan=" + SMALLER_EXAM_DATE);
    }
